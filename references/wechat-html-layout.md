...
> v3.6 起，增加「主题视觉化」原则：先达到花叔 95 分微信原生阅读感，再让文章主题长出自己的视觉语言。DeepSeek 视觉原语案例中，红色不是装饰色，而是指针色；坐标、点、框、路径线不是代码装饰，而是空间指认系统。
...
当文章已经达到花叔式 95 分微信原生阅读感，不要继续机械追求“更红、更像花叔”。下一步要问：
...
- **开篇结论用纯文本编号**：圆点胶囊显眼但拉高空间；技术读者更需要 15 秒扫完。
- **标题节奏要变化**：红底白字标题是花叔锚点，但长文里可穿插左线开放标题，避免组件疲劳。
...
| 坐标/代码块 | `background:#f5f5f5;border-left:4px solid #d32f2f` | 保留主题识别，不刺眼 |
| 尾部品牌 | `border-top:1px solid #eeeeee;color:#999999` | 轻，但有识别度 |

使用边界：

- 主题视觉化不是每篇都加花样，而是把文章核心概念转成排版语法。
- 如果主题没有明确视觉原语，宁可回到花叔 95 分基础版。
